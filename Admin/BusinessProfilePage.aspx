                        ...
                        <div class="panel-content">
                            <div class="form-row">
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <asp:RegularExpressionValidator ID="RegularExpressionValidator3" runat="server" ErrorMessage="Invalid GST Number" ForeColor="Red" ControlToValidate="txtGST" ValidationExpression="^[0-9]{2}[A-Z]{5}[0-9]{4}[A-Z]{1}[1-9A-Z]{1}Z[0-9A-Z]{1}$"></asp:RegularExpressionValidator>
                ...
                <div class="panel-container show">
                    <div class="panel-content">
                        <asp:Repeater ID="RepeaterBusiness" runat="server">
                            ...
                            <ItemTemplate>
                                <tr>
                                     <td><a class="btn btn-danger btn-sm" href="DeleteBusiness.aspx?Id=<%# Eval("Id")%>">
