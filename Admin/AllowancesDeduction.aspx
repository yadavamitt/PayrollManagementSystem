    ...
    <div class="row">
        <div class="col-xl-12">
            <div id="panel-6" class="panel">
                <div class="panel-hdr">
                    <h2>Employee Form - Allowances & Deduction
                    </h2>
                    ...
                    <div class="panel-content p-0">
                        <div class="panel-content">
                            ...
                            <div class="form-row">
                                ...
                                <div class="col-md-3 mb-3">
                                    <label class="form-label" for="validationDefault01">Other Deduction</label>
                                    ...
                                    <asp:TextBox ID="txtOtherDeducation" runat="server" placeholder="Other Deduction" onkeypress="SUM();" CssClass="form-control calculate calculateDeduction" OnTextChanged="txtOtherDeducation_TextChanged"></asp:TextBox>
                                </div>
