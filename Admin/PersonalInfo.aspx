                        ...
                        <div class="panel-content">
                            ...
                            <div class="form-row">
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <asp:RegularExpressionValidator ID="RegularExpressionValidator5" runat="server" ControlToValidate="txtCNIC" Display="Dynamic" ForeColor="Red" ErrorMessage="CNIC No must follow the XXXXX-XXXXXXX-X format!" ValidationExpression="^[0-9]{5}-[0-9]{7}-[0-9]$"></asp:RegularExpressionValidator>  
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <asp:RegularExpressionValidator ID="RegularExpressionValidator4" runat="server" ControlToValidate="txtAdharId" Display="Dynamic" ForeColor="Red" ErrorMessage="InValid Adhar Card" ValidationExpression="^(\d{12}|\d{16})$"></asp:RegularExpressionValidator>  
                                  ...
                                  <div class="col-md-4 mb-3">
                                    ...
                                    <asp:RegularExpressionValidator ID="RegularExpressionValidator3" runat="server" ControlToValidate="txtPANId" Display="Dynamic" ForeColor="Red" ErrorMessage="InValid PAN Card" ValidationExpression="[A-Z]{5}\d{4}[A-Z]{1}"></asp:RegularExpressionValidator>  
                                ...
                                <div class="col-md-2 mb-3">
                                  ...
                                  <div class="col-md-4 mb-3">
                                    <label class="form-label" for="validationDefault01">Qualification</label>
